...
function Trusted() {
  ...
  return (
    ...
    //           <i className="fas fa-users fa-3x"></i> {/* Font Awesome icon */}
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-4">
          <div className="trusted-box box1"> {/* Added class 'box1' */}
          <i className="fas fa-users fa-3x"></i> {/* Font Awesome icon */}
          <h3 className="count">{count1}+</h3>
          <p>People Trusted Us</p>
          </div>
        ...
        <div className="col-md-4">
          <div className="trusted-box box2"> {/* Added class 'box2' */}
          <i className="fas fa-hand-holding-heart fa-3x"></i>
            <h3 className="count">{count2}+</h3>
            <p>People Helped by Blood Donation</p>
          </div>
        ...
        <div className="col-md-4">
          <div className="trusted-box box3"> {/* Added class 'box3' */}
          <i className="fas fa-chart-line fa-3x"></i>
           <h3 className="count">{count3}+</h3>
           <p>Daily Users</p>
          </div>
